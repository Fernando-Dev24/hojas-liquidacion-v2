...
export const ConsolidadoBookingWrapper = ({ id }: Props) => {
  const { filterBy, orderBy, setOrder } = useAgendaStore()

  const createPDF = () => {
    exportAgendaConsolidado({ filter: filterBy })
  }
